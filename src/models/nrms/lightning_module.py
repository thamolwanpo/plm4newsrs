# src/models/nrms/lightning_module.py
...
class LitNRMSRecommender(pl.LightningModule):
    """
    PyTorch Lightning wrapper for NRMS model.
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.model = NRMSRecommenderModel(config)
